...
@app.post("/property_verification", dependencies=[Depends(Permissions.MANAGE_PROPERTY_VERIFICATIONS)])
...
@app.get("/property-verification", dependencies=[Depends(Permissions.VIEW_PROPERTY_VERIFICATIONS)])
